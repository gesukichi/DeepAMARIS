...
### 会話API
- **/conversation**: AI会話処理エンドポイント
- **/modern_rag_web_conversation**: AI会話処理エンドポイント
- **/history/list**: 会話履歴管理エンドポイント
- **/history/generate**: 会話履歴管理エンドポイント
- **/user/info**: ユーザー認証・情報管理エンドポイント
- **/.auth/me**: ユーザー認証・情報管理エンドポイント
- **/healthz**: システム状態・設定管理エンドポイント
- **/frontend_settings**: システム状態・設定管理エンドポイント
